-- SQL script for the Task 1 activity timeline: grade_scale.py
-- Activity categories intentionally match task1_timeline.R and Tasks 2-4.
...
ORDER BY tat.id, tat.research_id, tat.time;

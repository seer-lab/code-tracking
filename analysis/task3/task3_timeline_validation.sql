-- ============================================================================
-- Task 3 timeline validation: EVENT -> SQL CATEGORY -> R BIN -> DOMINANT CATEGORY
--
-- HOW TO USE:
...
--
-- OUTPUT:
--   * Every Task 3 activity event for every user is retained.
...
--     marker time.
--
-- CATEGORY PLACEMENT NOTES (Task 3): only Continue changed -- it's
-- classified only from its 3 explicit actions (no window-interval
-- inference -- see task3_timeline.R for why) and is excluded from bin-

...
Usage:
python tasktracker_actions_count.py [input_file_or_folder] [output_folder]
"""
...
import tasktracker_actions as tasktracker
...
def main():
    """Main function"""
    if len(sys.argv) < 3:
        print("Usage: python tasktracker_actions_count.py [input_file_or_folder] [output_folder]")
        print("Example: python tasktracker_actions_count.py data/user_24/ide-events.csv output/")
        print("Example: python tasktracker_actions_count.py study_data/ output/")
        sys.exit(1)

-- ============================================================================
-- Task 2 timeline validation: EVENT -> SQL CATEGORY -> R BIN -> DOMINANT CATEGORY
--
-- HOW TO USE:
...
--
-- OUTPUT:
--   * Every Task 2 activity event for every user is retained.
...
--     boundaries/contributions, dominant bin category, and Execution marker time.
-- ============================================================================

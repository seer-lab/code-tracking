...
This research project combines data collection tools with advanced analysis capabilities to understand how students approach programming problems. The collected data can be used to:

- Analyze programming patterns and student learning progression
- Generate automated hints for problem-solving
- Study coding behaviors in educational contexts
- Understand problem-solving strategies across different programming tasks
...
**Note**: A specialized version for testing behavior analysis is available in the `testing-study` branch.

**Features**:
- Code change pattern analysis with per-user and per-task reporting
- Data visualization tools for various metrics
- User behavior analysis and pattern recognition
- Modular data processing and visualization system
...
python analyze_patterns.py [prepared_data_folder]
python generate_visualizations.py [analysis_results_folder]
```
...
- **Coding Behavior Analysis**: Studying student approaches to programming

**Note**: A specialized version focused on testing behavior analysis is available in the `testing-study` branch.
